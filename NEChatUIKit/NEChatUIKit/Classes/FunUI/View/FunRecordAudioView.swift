...
open class FunRecordAudioView: UIView {
  ...
  lazy var lottieView: NELottieAnimationView = {
    let lottie = NELottieAnimationView(name: "fun_voice_data", bundle: chatUIKitLoader.bundle)
  ...
  public let recordGestureArea: UIImageView = {
    ...
    imageView.image = chatUIKitLoader.loadImage("fun_chat_record_gesture_inner")
    imageView.highlightedImage = chatUIKitLoader.loadImage("fun_chat_record_gesture_outter")
  ...
  public let recordCloseImage: UIImageView = {
    ...
    imageView.translatesAutoresizingMaskIntoConstraints = false
    imageView.image = chatUIKitLoader.loadImage("fun_chat_record_close_dark")
    imageView.highlightedImage = chatUIKitLoader.loadImage("fun_chat_record_close_light")
    imageView.isHighlighted = false
    return imageView
  }()
