...
Pod::Spec.new do |s|
  ...
  if ENV["USE_SOURCE_FILES"] == "true"
    ...
    s.source = { :http => "https://yx-web-nosdn.netease.im/xkit/IMUIKit/10.9.51/NEConversationUIKit_iOS_v10.9.51.framework.zip?download=NEConversationUIKit_iOS_v10.9.51.framework.zip" }
    
    s.subspec 'NOS' do |nos|
      nos.vendored_frameworks = 'NEConversationUIKit.xcframework'
    ...
    s.subspec 'FCS' do |fcs|
      fcs.vendored_frameworks = 'NEConversationUIKit.xcframework'
