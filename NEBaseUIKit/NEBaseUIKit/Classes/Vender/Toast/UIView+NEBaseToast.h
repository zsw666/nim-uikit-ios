...
extern const NSString * NEBaseToastPositionTop;
extern const NSString * NEBaseToastPositionCenter;
extern const NSString * NEBaseToastPositionBottom;

@class NEBaseToastStyle;


@interface UIView (NEBaseToast)
...
- (UIView *)ne_baseToastViewForMessage:(NSString *)message
                          title:(NSString *)title
                          image:(UIImage *)image
                          style:(NEBaseToastStyle *)style;
...
@interface NEBaseToastStyle : NSObject
...
@interface NEBaseToastManager : NSObject
