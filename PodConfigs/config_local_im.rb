...
module NELocalConversationUIKit
  def self.use_path
    true
  end
  ...
  def self.NOS_Special
    "NELocalConversationUIKit/NOS_Special"
  end

  def self.path
    "NELocalConversationUIKit/NELocalConversationUIKit.podspec"
  end

  def self.install(pod)
    if NELocalConversationUIKit.use_path
      puts "NELocalConversationUIKit use path"
      pod.pod NELocalConversationUIKit.name, :path => NELocalConversationUIKit.path
    else
      puts "NELocalConversationUIKit use http"
      pod.pod NELocalConversationUIKit.name, NELocalConversationUIKit.version
    end
  end
end
